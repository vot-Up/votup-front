...
import {candidateGuard} from "./app/candidate.guard";
...
export const ROUTES: Routes = [
  ...
  {path: "candidate", canActivate: [candidateGuard], loadChildren: () => import("./candidate/candidate.routes").then(m => m.ROUTES)},
